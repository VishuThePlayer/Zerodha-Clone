...
import { AuthContext } from "./AuthGuard"; // ✅ Import the context, NOT the component
    ...
    >
      ...
      <div className="menu-right" id="menu-drawer">
        <ul className="menu-list" onClick={() => setOpen(false)}>
          <li>
            <Link to="/" className="menu-link" aria-current="page">
              Dashboard
            </Link>
          </li>
          <li>
        ...
        <div className="user">
          ...
          <span className="user-id">{user?.username ?? "Guest"}</span>
        </div>
      </div>
