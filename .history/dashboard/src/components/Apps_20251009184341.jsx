      ...
      >
        ...
        <Box display="flex" alignItems="center" justifyContent="space-between" mb={4}>
          <Box display="flex" alignItems="center" gap={2}>
            <ShowChart sx={{ fontSize: 40, color: "var(--accent-primary)" }} />
            <Typography
              variant="h4"
              fontWeight="bold"
        ...
        {error && (
          <Alert
            ...
            icon={<ErrorOutline sx={{ color: "var(--loss)" }} />}
            action={
          ...
          <Box>
            ...
            >
              <CardContent>
                ...
                <Box display="flex" justifyContent="space-between" alignItems="flex-start" mb={2}>
                  <Box>
                    ...
                    <Box display="flex" alignItems="center" gap={1.5} mt={1} flexWrap="wrap">
                      <Chip
                        label={searchResult.info.symbol}
                        size="small"
                        sx={{
                  ...
                  <Box textAlign="right">
                    <Typography variant="h4" fontWeight="bold" sx={{ color: "var(--text-primary)" }}>
                      ₹{searchResult.priceInfo?.lastPrice}
                    </Typography>
                    <Box
                      display="flex"
                      alignItems="center"
                      ...
                      gap={0.5}
                      color={
                        parseFloat(searchResult.priceInfo?.change) >= 0
                          ? "var(--profit)"
                          : "var(--loss)"
                      }
                    >
                      ...
                      <Typography variant="body1" fontWeight="600">
                        {`${searchResult.priceInfo?.change} (${searchResult.priceInfo?.pChange}%)`}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                ...
                {/* Other sections remain identical — keep MUI structure */}
              </CardContent>
            </Card>
          </Box>
        )}
        ...
        >
          ...
          <Typography variant="caption" color="var(--text-muted)" display="block" mt={2}>
