      ...
      <CardContent>
          ...
          <Box>
            ...
            >
              ...
              <Typography variant="body2" color="text.secondary">
                {searchResult.industryInfo?.industry ||
                  searchResult.info.industry ||
                  "N/A"}
              </Typography>

              {searchResult.metadata?.status && (
                <Chip
                  label={searchResult.metadata.status}
                  size="small"
                  color="success"
                />
              )}
          ...
          <Box textAlign="right">
            ...
            {searchResult.priceInfo && (
              <Box
                ...
                color={
                  formatChange(
                    searchResult.priceInfo.change,
                    searchResult.priceInfo.pChange
                  ).isPositive
                    ? "success.main"
                    : "error.main"
                }
          ...
          <Grid item xs={6} md={3}>
            ...
            <Typography variant="body1" fontWeight="600">
              {searchResult.priceInfo?.totalTradedValue
                ? `₹${(
                    searchResult.priceInfo.totalTradedValue / 10000000
                  ).toFixed(2)}`
                : "N/A"}
            </Typography>
          </Grid>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={6} md={4}>
            ...
            <Typography variant="body1" fontWeight="600">
              {searchResult.info.listingDate ||
                searchResult.metadata?.listingDate ||
                "N/A"}
            </Typography>
          </Grid>
