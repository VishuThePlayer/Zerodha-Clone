...
import { holdings } froimport DataSaverOffIcon from '@mui/icons-material/DataSaverOff';
function Summary() {
      ...
      <div className="summary">
          ...
          <div className="equity-content">
            <div className="equity-content-1">
              <div className="equity-number">
                <h1>{(marginAvailable / 1000).toFixed(2)}k</h1>
              </div>
              <div className="equity-number">
        ...
        <div className="Holding">
          ...
          <div className="equity-content">
            <div className="equity-content-1">
              <div className="equity-number">
                <h1>{(currentValue / 1000).toFixed(2)}k</h1>
              </div>
            </div>
            <div className="equity-content-2">
