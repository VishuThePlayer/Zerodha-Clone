    ...
    const fetchWatchlist = async () => {
      try {
        const res = await axios.get(
          "https://zerodha-clone-d94u.vercel.app/api/watchlist/allWatchlist",
...
const WatchListActions = ({ uid, Currprice }) => {
  const { openBuyWindow, openGraph } = useContext(GeneralContext);
  ...
  return (
    ...
    >
      ...
      <Tooltip title="View Chart" placement="top" arrow slots={{ transition: Grow }}>
        <button className="action" onClick={() => openGraph(uid)}>
