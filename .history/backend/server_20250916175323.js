...
// Middlewares
const corsOptions = {
  origin: "http://localhost:${const PORT = process.env.PORT || 5000;}", // frontend ka URL
...
app.post('/signup',validateSchema(signupSchemaValidation) ,Signup);
...
app.post("/newOrder", async (req, res) => {
    try {
        ...
        const newOrder = new Orders(data); // Model ka instance
