          ...
          <div className={`collapse navbar-collapse ${menuOpen ? "show" : ""}`} id="mainNavbar">
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center">
              <li className="nav-item">
                <a className="nav-link" href="https://zerodha.com/open-account/">Signup</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="https://zerodha.com/about/">About</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="https://zerodha.com/products/">Products</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="https://zerodha.com/pricing/">Pricing</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="https://support.zerodha.com">Support</a>
              </li>
