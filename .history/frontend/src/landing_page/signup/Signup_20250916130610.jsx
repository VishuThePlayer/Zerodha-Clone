      ...
      <section className="py-5 bg-light">
        <div className="container">
          ...
          <div className="row g-4 justify-content-center">
            {[
              { img: "https://zerodha.com/static/images/stocks-acop.svg", title: "Stocks", text: "Invest in all exchange-listed securities" },
              { img: "https://zerodha.com/static/images/mf-acop.svg", title: "Mutual funds", text: "Invest in commission-free direct mutual funds" },
              { img: "https://zerodha.com/static/images/ipo-acop.svg", title: "IPO", text: "Apply to the latest IPOs instantly via UPI" },
              { img: "https://zerodha.com/static/images/fo-acop.svg", title: "Futures & options", text: "Hedge and mitigate market risk through simplified F&O trading" },
            ].map((card, i) => (
      ...
      <section className="py-5">
        <div className="container">
          ...
          <div className="row g-4">
            {[
              { img: "https://zerodha.com/static/images/acop-individual.svg", title: "Individual Account", text: "Invest in equity, mutual funds and derivatives", link: "https://signup.zerodha.com/" },
              { img: "https://zerodha.com/static/images/acop-huf.svg", title: "HUF Account", text: "Make tax-efficient investments for your family", link: "https://support.zerodha.com/category/account-opening/company-partnership-and-huf-account-opening/huf" },
              { img: "https://zerodha.com/static/images/acop-nri.svg", title: "NRI Account", text: "Invest in equity, mutual funds, debentures, and more", link: "https://zerodha.com/open-account/nri" },
              { img: "https://zerodha.com/static/images/acop-minor.svg", title: "Minor Account", text: "Teach your little ones about money & invest for their future with them", link: "https://signup.zerodha.com/minor/" },
              { img: "https://zerodha.com/static/images/acop-corporate.svg", title: "Corporate / LLP/ Partnership", text: "Manage your business surplus and investments easily", link: "https://support.zerodha.com/category/account-opening/company-partnership-and-huf-account-opening" },
            ].map((card, i) => (
