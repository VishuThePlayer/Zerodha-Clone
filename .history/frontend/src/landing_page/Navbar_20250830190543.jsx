        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="fs-5 navbar-nav ms-auto gap-5 mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                Link className="nav-link" href="#">About</a>
              </li>
              <li className="nav-item">
                Link className="nav-link" href="#">Products</a>
              </li>
              <li className="nav-item">
                Link className="nav-link" href="#">Pricing</a>
              </li>
              <li className="nav-item">
                Link className="nav-link" href="#">Support</a>
              </li>
