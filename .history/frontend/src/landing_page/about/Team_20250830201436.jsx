  ...
  return (
    <div className="container my-5">
      ...
      <div className="row justify-content-center align-items-start g-5">
        ...
        <p className="lh-lg mb-3">
            I’ve gained hands-on experience as a <strong>Frontend Developer at 1Stop.ai</strong>, where I 
            built responsive, user-friendly web applications including an interactive to-do list. My personal 
        ...
        <p className="lh-lg mb-3">
            My technical toolkit includes <strong>JavaScript, C++, Python, React.js, Node.js, Express.js, 
