          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ms-auto gap-5 mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                ...
                <ul classNam="dropdown-menu">
                <li><a classNam="dropdown-item" href="#">Action</a></li>
                <li><a classNam="dropdown-item" href="#">Another action</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a classNam="dropdown-item" href="#">Something else here</a></li>
            </ul>
          </div>
        </div>
      </nav>
