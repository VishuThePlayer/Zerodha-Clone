...
const styles = `
  ...
  .pricing-right { display: flex; justify-content: center; gap: 3rem; flex-wrap: nowrap; }
  .price-item { display: flex; flex-direction: column; align-items: center; text-align: center; min-width: 200px; }
  ...
  .tagline { color: #4a5568; font-size: .95rem; line-height: 1.3; margin-top: .5rem; }
