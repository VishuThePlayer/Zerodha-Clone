...
function Navbar() {
  return ( 
    <nav className="navbar navbar-expand-lg p-2 sticky-top bg-white shadow-sm">
      <div className="container-fluid<nav className="navbar navbar-expand-lg p-2 sticky-top bg-white shadow-sm"><nav className="navbar navbar-expand-lg p-2 sticky-top bg-white shadow-sm">">
        {/* Brand / Logo */}
