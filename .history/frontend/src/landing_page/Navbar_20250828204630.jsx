        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="dropdown-menu">
                <li><a classNM="dropdown-item" href="#">Action</a></li>
                <li><a classNM="dropdown-item" href="#">Another action</a></li>
                <li><hr classNM="dropdown-divider"></li>
                <li><a classNM="dropdown-item" href="#">Something else here</a></li>
            </ul>
          </ul>
          </div>
        </div>
